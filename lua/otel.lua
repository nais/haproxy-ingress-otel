...
--
-- Environment variables (per OTLP spec):
...
--      HTTP default: http://localhost:4318 (auto-appends /v1/traces)
...
--      Values: "grpc", "http/protobuf", "http/json"
